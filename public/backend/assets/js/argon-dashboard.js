...
function sidebarType(a) {
 ...
 if(a.value==='active'){
   sessionStorage.removeItem("darksidebar");
    location.reload()
 }else{
   sessionStorage.setItem("darksidebar", 'active');
    location.reload()
 }
...
if(sessionStorage.getItem('darksidebar')){
 console.log(sessionStorage.getItem('darksidebar'));
  $('#sidebarDarkONOFF').html(`<button class="btn bg-gradient-primary w-100 px-3 mb-2  me-2"  value="active" data-class="bg-white" onclick="sidebarType(this)">White</button><button class="btn bg-gradient-primary  w-100 px-3 mb-2 active" value="inactive" data-class="bg-default" onclick="sidebarType(this)">Dark</button>`);

  var parent = ['button.btn.bg-gradient-primary.w-100.px-3.mb-2.active.me-2, button.btn.bg-gradient-primary.w-100.px-3.mb-2'];
  ...
  var bodyDark = body.classList.contains('dark-version');
    ...
    $('#sidebarDarkONOFF').html(`<button class="btn bg-gradient-primary w-100 px-3 mb-2  me-2 active"  value="active" data-class="bg-white" onclick="sidebarType(this)">White</button><button class="btn bg-gradient-primary w-100 px-3 mb-2" value="inactive" data-class="bg-default" onclick="sidebarType(this)">Dark</button>`);
...
function darkMode(el) {
  ...
  // console.log('darkchecksee',sessionStorage.getItem('darkmode'));
