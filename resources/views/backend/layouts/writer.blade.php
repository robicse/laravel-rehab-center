...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{url('/writer/dashboard')}}">
            <img src="{{ asset('backend/assets/img/logo-ct-dark.png') }}" class="navbar-brand-img h-100"
                alt="main_logo">
            <span class="ms-1 font-weight-bold">Rehab</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                ...
                <a class="nav-link {{Request::is(Request::segment(1) .'/writer-profile*') ? 'active' : ''}}"
                href="{{route(Request::segment(1) . '.writer-profile.index')}}">
                <div
            ...
            <li class="nav-item">
                <a class="nav-link {{Request::is(Request::segment(1) .'/rehab-lists*') ? 'active' : ''}}"
                    href="{{route(Request::segment(1) . '.rehab-lists.index')}}">
                    <div
                        class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-ungroup text-warning text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Rehab List  </span>
                </a>
            </li> 
            <li class="nav-item">
                <a class="nav-link {{Request::is(Request::segment(1) .'/rehab-review-lists*') ? 'active' : ''}}"
                    href="{{route(Request::segment(1) . '.rehab-review-lists.index')}}">
                    <div
                        class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-bell-55 text-danger text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Rehab Review  </span>
                </a>
            </li> 
