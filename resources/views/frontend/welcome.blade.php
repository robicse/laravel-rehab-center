                    ...
                    <div class="row find-img-align">
                        <div class="col-md-12">
                            <div class="find-place-img_wrap">
                                <div class="grid">
                                    <figure class="effect-ruby">
                                        <img src="{{ asset('frontend/images/find-place3.jpg')}}" />
                                        <figcaption>
                                            <h5>Restaurants</h5>
                                            <p>210 Listings</p>
                                        </figcaption>
            ...
            <div class="row">
                <div class="col-md-4 featured-responsive">
                    <div class="featured-place-wrap">
                        <a href="detail.html">
                            <img src="{{ asset('frontend/images/featured1.jpg')}}" alt="#" class="img-fluid">
                ...
                <div class="col-md-4 featured-responsive">
                    <div class="featured-place-wrap">
                        <a href="detail.html">
                            <img src="{{ asset('frontend/images/featured2.jpg')}}" alt="#" class="img-fluid">
                ...
                <div class="col-md-4 featured-responsive">
                    <div class="featured-place-wrap">
                        <a href="detail.html">
                            <img src="{{ asset('frontend/images/featured3.jpg')}}" alt="#" class="img-fluid">
